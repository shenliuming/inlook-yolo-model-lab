...
try:
    from .subtitle_pack import build_subtitle_filter, check_ffmpeg, run, video_has_audio_stream
except ImportError:
    from subtitle_pack import build_subtitle_filter, check_ffmpeg, run, video_has_audio_stream  # type: ignore
