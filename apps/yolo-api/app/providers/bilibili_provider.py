...
class BilibiliProvider(MaterialProvider):
    ...
    def fetch_material(
        ...
        *,
        ...
        if detect_platform_from_url(source_url) != "bilibili":
            raise HTTPException(status_code=400, detail="当前链接不是 B 站链接")
